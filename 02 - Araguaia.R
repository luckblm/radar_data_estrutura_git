...
saveWorkbook(
  wb,
  "araguaia/Tabela 1 - População, Área Territorial km2 e Densidade Demográfica.xlsx",
  overwrite = TRUE
)
...
# Salvar o arquivo Excel
saveWorkbook(wb,
             "araguaia/Tabela 2 - População por Sexo e Razão entre os Sexos.xlsx",
             overwrite = TRUE
)
...
# Salvar o arquivo Excel
saveWorkbook(wb, "araguaia/Tabela 3 - População por Faixa Etária.xlsx", overwrite = TRUE)
...
saveWorkbook(
  wb,
  "araguaia/Tabela 4 - Proporção de Idosos, Razão de Dependência e Índice de Envelhecimento.xlsx",
  overwrite = TRUE
)
# EDUCAÇÃO----
...
saveWorkbook(
  wb,
  "araguaia/Tabela 5 - Número de Matrículas nos Ensinos Pré-escolar, Fundamental e Médio por Esfera Administrativa.xlsx",
  overwrite = TRUE
)
...
saveWorkbook(
  wb,
  "araguaia/Tabela 6 - Estabelecimentos de Ensino Fundamental e Médio por Dependência Administrativa.xlsx",
  overwrite = TRUE
)
...
saveWorkbook(
  wb,
  "araguaia/Tabela 7 - Número de Docentes nos Ensinos Pré-escolar, Fundamental e Médio por Esfera Administrativa.xlsx",
  overwrite = TRUE
)
...
saveWorkbook(
  wb,
  "araguaia/Tabela 8 - Taxas de Aprovação, Reprovação e Evasão no Ensino Fundamental por Esfera Administrativa.xlsx",
  overwrite = TRUE
)
...
saveWorkbook(
  wb,
  "araguaia/Tabela 9 - Taxas de Aprovação, Reprovação e Evasão no Ensino Médio por Esfera Administrativa.xlsx",
  overwrite = TRUE
)
...
# Salvar o arquivo Excel
saveWorkbook(wb,
             "araguaia/Tabela 10 - Distorção Idade-Série Total por Nível de Ensino.xlsx",
             overwrite = TRUE
)
...
saveWorkbook(
  wb,
  "araguaia/Tabela 11 - Índice de Desenvolvimento da Educação Básica - IDEB_Escola Pública.xlsx",
  overwrite = TRUE
)
...
# Salvar o arquivo Excel
saveWorkbook(wb,
             "araguaia/Tabela 12 - Média de Alunos por Nível de Ensino.xlsx",
             overwrite = TRUE
)
# SAÚDE----
...
saveWorkbook(
  wb,
  "araguaia/Tabela 13 - Taxas de Mortalidade Infantil, Mortalidade em Menores que 05 Anos e Mortalidade Materna.xlsx",
  overwrite = TRUE
)
...
saveWorkbook(
  wb,
  "araguaia/Tabela 14 - Taxas de Mortalidade Geral e Percentual de Mortes por sexo.xlsx",
  overwrite = TRUE
)
...
saveWorkbook(
  wb,
  "araguaia/Tabela 15 - Taxa de Natalidade e Percentual de Nascidos Vivos por tipo de Parto.xlsx",
  overwrite = TRUE
)
...
saveWorkbook(
  wb,
  "araguaia/Tabela 16 - Percentual de Nascidos Vivos Conforme o Número de Consultas Pré-Natal.xlsx",
  overwrite = TRUE
)
...
saveWorkbook(
  wb,
  "araguaia/Tabela 17 - Percentual de Nascidos Vivos Conforme a Faixa Etária da Mãe e Razão de Exames Citopatológicos do Colo do Útero em Mulheres de 25 a 64 anos.xlsx",
  overwrite = TRUE
)
...
# Salvar o arquivo Excel
saveWorkbook(wb,
             "araguaia/Tabela 18 - Óbitos segundo Principais Causas CID_10.xlsx",
             overwrite = TRUE
)
...
# Salvar o arquivo Excel
saveWorkbook(wb,
             "araguaia/Tabela 19 - Caracterização Hospitalar por Tipo.xlsx",
             overwrite = TRUE
)
...
saveWorkbook(
  wb,
  "araguaia/Tabela 20 - Médicos e Profissionais de Ensino Superior na Área da Saúde.xlsx",
  overwrite = TRUE
)
...
# Salvar o arquivo Excel
saveWorkbook(wb,
             "araguaia/Tabela 21 – Caracterização Leitos Existentes.xlsx",
             overwrite = TRUE
)
...
saveWorkbook(
  wb,
  "araguaia/Tabela 22 – Caracterização Hospitalar – Equipamentos de diagnósticos por imagem e infra estrutura.xlsx",
  overwrite = TRUE
)
# MERCADO DE TRABALHO----
...
saveWorkbook(
  wb,
  "araguaia/Tabela 23 - Vínculos Empregatícios Total e por Sexo no Emprego Formal.xlsx",
  overwrite = TRUE
)
...
saveWorkbook(
  wb,
  "araguaia/Tabela 24 - Vínculos Empregatícios no Emprego Formal por Grande Setor_IBGE.xlsx",
  overwrite = TRUE
)
...
saveWorkbook(
  wb,
  "araguaia/Tabela 25 - Vínculos Empregatícios no Emprego Formal por Setor Econômico.xlsx",
  overwrite = TRUE
)
...
saveWorkbook(
  wb,
  "araguaia/Tabela 26 - Vínculos Empregatícios por Escolaridade do Trabalhador Formal.xlsx",
  overwrite = TRUE
)
...
saveWorkbook(
  wb,
  "araguaia/Tabela 27 - Remuneração Média (R$) Total e por Sexo do Trabalhador Formal.xlsx",
  overwrite = TRUE
)
...
saveWorkbook(
  wb,
  "araguaia/Tabela 28 - Informações de Famílias Inscritas no Cadastro Único para Programas Sociais_CadÚnico e Bolsa Família.xlsx",
  overwrite = TRUE
)
...
saveWorkbook(
  wb,
  "araguaia/Tabela 29 - Arrecadação e Benefícios Emitidos pela Previdência Social.xlsx",
  overwrite = TRUE
)
# SEGURANÇA----
...
saveWorkbook(
  wb,
  "araguaia/Tabela 30 - Número de Óbitos por Agressão, População e Taxa de Homicídio Total.xlsx",
  overwrite = TRUE
)
...
saveWorkbook(
  wb,
  "araguaia/Tabela 31 - Número de Óbitos de Jovens de 15 a 29 anos por Agressão, População Jovem e Taxa de Homicídio de Jovens.xlsx",
  overwrite = TRUE
)
...
saveWorkbook(
  wb,
  "araguaia/Tabela 32 - Número de Óbitos por Acidente de Trânsito, População e Taxa de Homicídio no Trânsito.xlsx",
  overwrite = TRUE
)
# MEIO AMBIENTE----
...
saveWorkbook(
  wb,
  "araguaia/Tabela 33 - Desflorestamento Acumulado _km²_, Incremento do Desflorestamento _km²_ e Focos de Calor.xlsx",
  overwrite = TRUE
)
...
# Salvar o arquivo Excel
saveWorkbook(wb,
             "araguaia/Tabela 34 - Área de Floresta _km²_ e Hidrografia _km²_.xlsx",
             overwrite = TRUE
)
...
saveWorkbook(
  wb,
  "araguaia/Tabela 35 - Área Territorial, Área Cadastrável e Área Cadastrada no Cadastro Ambiental Rural_CAR.xlsx",
  overwrite = TRUE
)
# ECONOMIA----
...
saveWorkbook(
  wb,
  "araguaia/Tabela 36 - Produto Interno Bruto Total, Valor Adicionado e Impostos (R$ 1.000).xlsx",
  overwrite = TRUE
)
...
saveWorkbook(
  wb,
  "araguaia/Tabela 37 - Valor Adicionado Total e por Setores com Administração Pública.xlsx",
  overwrite = TRUE
)
...
saveWorkbook(
  wb,
  "araguaia/Tabela 38 -Participação do Valor Adicionado dos Setores e da Administração Pública em relação ao Total do Estado.xlsx",
  overwrite = TRUE
)
...
saveWorkbook(
  wb,
  "araguaia/Tabela 39 - Participação do Valor Adicionado dos Setores e da Administração Pública em relação ao Município.xlsx",
  overwrite = TRUE
)
...
saveWorkbook(
  wb,
  "araguaia/Tabela 40 - PIB Total_ Ranking Estadual e Participação em Relação ao Estado e a Região de Integração.xlsx",
  overwrite = TRUE
)
...
saveWorkbook(
  wb,
  "araguaia/Tabela 41 - PIB Total População, PIB per capita e Razão entre PIB per capita do Município e do Estado.xlsx",
  overwrite = TRUE
)
...
saveWorkbook(
  wb,
  "araguaia/Tabela 42 - Balança Comercial - Exportação, Importação e Saldo.xlsx",
  overwrite = TRUE
)
...
saveWorkbook(
  wb,
  "araguaia/Tabela 43 - Área colhida_ Quantidade Produzida e Valor da Produção por Tipo de Lavoura Permanente.xlsx",
  overwrite = TRUE
)
...
saveWorkbook(
  wb,
  "araguaia/Tabela 44 - Área colhida Quantidade Produzida e Valor da Produção por Tipo de Lavoura Temporária.xlsx",
  overwrite = TRUE
)
...
# Salvar o arquivo Excel
saveWorkbook(wb, "araguaia/Tabela 45 - Efetivo de Rebanho por Tipo.xlsx", overwrite = TRUE)
...
# Salvar o arquivo Excel
saveWorkbook(wb,
             "araguaia/Tabela 46 - Produção de Origem Animal por Tipo.xlsx",
             overwrite = TRUE
)
# FINANÇAS PÚBLICAS----
...
# Salvar o arquivo Excel
saveWorkbook(wb,
             "araguaia/Tabela 47 - Repasse e Participação ICMS, IPI E IPVA.xlsx",
             overwrite = TRUE
)
...
saveWorkbook(
  wb,
  "araguaia/Tabela 48 - Receitas Orçamentária, Corrente, Transferidas e Impostos.xlsx",
  overwrite = TRUE
)
# INFRAESTRUTURA----
...
saveWorkbook(
  wb,
  "araguaia/Tabela 49 - Consumo de Energia Elétrica Total_kWH e Consumidores de Energia Elétrica por Tipo.xlsx",
  overwrite = TRUE
)
...
saveWorkbook(
  wb,
  "araguaia/Tabela 50 - Total da Frota de Veículos subdivididos em Licenciados e Não Licenciados.xlsx",
  overwrite = TRUE
)
...
# Salvar o arquivo Excel
saveWorkbook(wb,
             "araguaia/Tabela 51 - Total da Frota de Veículos por Tipo.xlsx",
             overwrite = TRUE
)
